...
/**
 * The <code>MatchEngine</code> service will apply sell and buy orders against
 * the book.
 * <p>
 * The book is a list of sell orders and a list of buy orders. Incoming orders
 * will be matched against the appropriate list reducing quantity counts and
 * removing orders once qty for a specific price is used. Any unmatched amounts
 * will result in new orders added to the book.
 * 
 */
@Singleton
public class MatchEngine {
    ...
    /**
     * Apply a sell order against buy orders starting with the highest price buy
     * order.
     * 
     * @param sellOrder
     */
    ...
    /**
     * Apply a buy order against sell orders starting with the lowest price sell
     * order.
     * 
     * @param buyOrder
     */
     ...
     * 
     * The list passed in is already sorted in the correct order. This allows buys
     * to be applied against ascending sells and sells to be applied against
     * descending buys.
     * 
     * @param order
     *            the sell or buy order
     * @param orders
     *            list of buys or sells from the book
     * @param addOrder
     *            function to add remaining qty as a new order to the book
     */
     ...
     * 
     * Method is synchronized to prevent underlying changes to the buy and sell
     * lists while serializing the lists to a json format.
     * 
     * <pre>
     *   {
